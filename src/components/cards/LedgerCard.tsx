      ...
      <div className="overflow-hidden rounded-xl border border-gray-100">
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              <th className="text-left py-2.5 px-3 text-xs font-semibold text-gray-500">Seed In</th>
              <th className="text-left py-2.5 px-3 text-xs font-semibold text-gray-500">Surplus</th>
              <th className="text-left py-2.5 px-3 text-xs font-semibold text-gray-500">Mission</th>
              <th className="text-center py-2.5 px-2 text-xs font-semibold text-gray-500">Status</th>
            </tr>
          </thead>
          <tbody>
