  ...
  return (
    <div className="w-full bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-4 shadow-lg text-white">
      ...
      <div className="grid grid-cols-3 gap-1.5 mb-2">
        ...
        <div className="bg-white/5 rounded-lg p-1.5 text-center hover:bg-white/10 transition-colors">
          <p className="font-bold text-sm animate-number-tick" style={{ animationDelay: '0.2s' }}>1,247</p>
          <p className="text-[10px] text-gray-400 leading-tight">seeders</p>
        </div>
        <div className="bg-white/5 rounded-lg p-1.5 text-center hover:bg-white/10 transition-colors">
          <p className="font-bold text-sm animate-number-tick" style={{ animationDelay: '0.4s' }}>23</p>
          <p className="text-[10px] text-gray-400 leading-tight">countries</p>
        </div>
      </div>
