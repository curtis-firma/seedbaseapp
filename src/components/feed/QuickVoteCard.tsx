...
export function QuickVoteCard() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-4 py-3 bg-gradient-to-r from-[#0000ff]/10 to-[#0000ff]/5 border-b border-border/50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#0000ff]/20 flex items-center justify-center">
              <Vote className="w-4 h-4 text-[#0000ff]" />
            </div>
            <div>
          ...
          <div className="px-2 py-0.5 rounded-full bg-[#0000ff]/20 text-[#0000ff] text-xs font-medium">
        ...
        {activeVotes.slice(0, 2).map((vote) => (
          <div key={vote.id} className="p-3 rounded-xl bg-muted/30">
            ...
            <div className="flex items-center justify-between mt-1.5 text-xs text-muted-foreground">
              <span className="text-[#0000ff] font-medium">{vote.yesPercent}% Yes</span>
      ...
      <div className="px-3 pb-3">
        <motion.button
          ...
          className="
            ...
            shadow-[0_0_12px_rgba(0,0,255,0.3)]
            hover:shadow-[0_0_20px_rgba(0,0,255,0.5)]
