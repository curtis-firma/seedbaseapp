...
const LiveDataState = () => {
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center p-4 md:p-6">
      ...
      {/* Main content - larger donut and voting */}
      <div className="flex items-center gap-4 md:gap-8 mt-8">
        ...
        {/* Larger allocation list with voting */}
      ...
      <motion.p
        ...
        className="absolute bottom-4 md:bottom-5 left-1/2 -translate-x-1/2 text-xs text-black/40 font-medium"
      >
